...
import { Stack, Flex, Text, VStack, HStack, useBreakpointValue, IconButton, useColorModeValue, chakra, VisuallyHidden, Box, Button } from "@chakra-ui/react";
...
export default function WithBackgroundVideo() {
  ...
  return (
    <Flex w="100vw" h="100vh" position="relative" overflow="hidden">
      ...
      <VStack w="full" h="full" justify="center" align="center" spacing={6} bgGradient="linear(to-r, blackAlpha.600, transparent)">
        <Button
        ...
        <Stack maxW="2xl" align="center" spacing={3}>
          {/* Centered Logo Image */}
          <Box opacity={isReady ? 1 : 0} transform={isReady ? "translateY(0)" : "translateY(20px)"} transition="opacity 1.5s ease, transform 1.5s ease">
